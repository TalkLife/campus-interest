	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'p',
	                        null,
	                        'TalkLife is already one of the world’s leading peer to peer support networks with hundreds of thousands of users from all around the world. It’s a safe, moderated community which values encouragement and acceptance.'
	                    ),
	                    React.createElement(
	                        'p',
	                        null,
	                        'We are excited to announce that TalkLife Campus is coming. It is built for students, where they can chat with other students in a safe and encouraging environment. They will also be able to access all of your campus student mental health services in one place.'
	                    ),
	                    form
	                )
	            )
